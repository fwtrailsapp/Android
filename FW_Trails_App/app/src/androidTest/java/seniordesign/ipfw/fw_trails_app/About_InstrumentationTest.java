...
@LargeTest
public class About_InstrumentationTest {

   private final String toolbarTitle = "About";
   ...
   public void navDrawerOpen(){
      ...
      onView(withText(R.string.navDrawer_aboutTitle)).perform(click());
   }
   ...
   @Test
   public void aboutStatementTextVerification(){
